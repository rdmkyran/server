    ...
    [xi.zone.NORTH_GUSTABERG] =
    {
        ...
        [3] = function(player)
            ...
            return player:hasItem(xi.items.APOCALYPSE) or
                ...
                player:hasItem(xi.items.APOCALYPSE_99_AFTERGLOW) or
                player:hasItem(xi.items.APOCALYPSE_99_2) or
                player:hasItem(xi.items.APOCALYPSE_99_2_AFTERGLOW) or
                player:hasItem(xi.items.APOCALYPSE_99_3)
        end,

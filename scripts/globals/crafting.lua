...
local testItemsByNPC =
{
    ...
    ["Reinberta"]      = { xi.items.COPPER_HAIRPIN      , xi.items.BRASS_HAIRPIN         , xi.items.SILVER_HAIRPIN           , xi.items.CHAIN_GORGET    , xi.items.MYTHRIL_RING    , xi.items.MYTHRIL_GORGET         , xi.items.MYTHRIL_BREASTPLATE      , xi.items.TORQUE              , xi.items.COLICHEMARDE        , xi.items.EVADER_EARRING            },
    ["Faulpie"]        = { xi.items.RABBIT_MANTLE       , xi.items.LIZARD_CESTI          , xi.items.DHALMEL_MANTLE           , xi.items.MAGIC_BELT      , xi.items.CUIR_BOUILLI    , xi.items.RAPTOR_JERKIN          , xi.items.BATTLE_BOOTS             , xi.items.TIGER_GLOVES        , xi.items.COEURL_MASK         , xi.items.URJA_TROUSERS             },
    ["Mevreauche"]     = { xi.items.XIPHOS              , xi.items.ASPIS                 , xi.items.BILBO                    , xi.items.WAR_PICK        , xi.items.MYTHRIL_PICK    , xi.items.DARKSTEEL_FALCHION     , xi.items.BASCINET                 , xi.items.BASTARD_SWORD       , xi.items.CELATA              , xi.items.GORKHALI_KUKRI            },
    ["Ghemp"]          = { xi.items.XIPHOS              , xi.items.ASPIS                 , xi.items.BILBO                    , xi.items.WAR_PICK        , xi.items.MYTHRIL_PICK    , xi.items.DARKSTEEL_FALCHION     , xi.items.BASCINET                 , xi.items.BASTARD_SWORD       , xi.items.CELATA              , xi.items.GORKHALI_KUKRI            },
    ["Cheupirudaux"]   = { xi.items.WORKBENCH           , xi.items.MAPLE_TABLE           , xi.items.HARP                     , xi.items.TRAVERSIERE     , xi.items.ROSE_WAND       , xi.items.KAMAN                  , xi.items.EBONY_WAND               , xi.items.COMMODE             , xi.items.MYTHIC_POLE         , xi.items.VEJOVIS_WAND              },
}

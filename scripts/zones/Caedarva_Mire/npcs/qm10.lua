...
entity.onEventFinish = function(player, csid, option)
    if csid == 15 then
        npcUtil.completeQuest(player, xi.quest.log_id.AHT_URHGAN, xi.quest.id.ahtUrhgan.OPERATION_TEATIME, { item = xi.items.PUPPETRY_CHURIDARS, var = "OperationTeatimeProgress" })
    end
end

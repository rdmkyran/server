...
entity.onTrade = function(player, npc, trade)
    ...
    if guardian == QUEST_ACCEPTED and trade:hasItemQty(xi.items.BUNCH_OF_WILD_PAMAMAS, 1) then
    ...
    elseif guardian == QUEST_COMPLETED and trade:hasItemQty(xi.items.BUNCH_OF_WILD_PAMAMAS, 1) then
        player:messageSpecial(ID.text.ALTAR_OFFERING, 0, 4596)

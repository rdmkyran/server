...
entity.onTrade = function(player, npc, trade)
    ...
    local goodtrade = trade:hasItemQty(xi.items.SET_OF_GIANT_FISH_BONES, 1)
    local badtrade = trade:hasItemQty(xi.items.BROKEN_MITHRAN_FISHING_ROD, 1) or trade:hasItemQty(xi.items.WORKBENCH, 1) or trade:hasItemQty(xi.items.TEN_OF_COINS_CARD, 1) or trade:hasItemQty(xi.items.HANDFUL_OF_THE_SANDS_OF_SILENCE, 1) or trade:hasItemQty(xi.items.WANDERING_BULB, 1) or trade:hasItemQty(xi.items.BLACKENED_TOAD, 1) or trade:hasItemQty(xi.items.WYVERN_SKULL, 1) or trade:hasItemQty(xi.items.ROCK_OF_ANCIENT_SALT, 1) or trade:hasItemQty(xi.items.LUCKY_EGG, 1)

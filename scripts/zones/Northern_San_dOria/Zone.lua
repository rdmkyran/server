...
zoneObject.onEventFinish = function(player, csid, option)
    ...
    elseif
        csid == 49 and
        npcUtil.completeQuest(player, xi.quest.log_id.SANDORIA, xi.quest.id.sandoria.PEACE_FOR_THE_SPIRIT, { item = xi.items.WARLOCKS_CHAPEAU, fame = 60, title = xi.title.PARAGON_OF_RED_MAGE_EXCELLENCE })
    then

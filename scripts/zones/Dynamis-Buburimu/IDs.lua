...
zones[xi.zone.DYNAMIS_BUBURIMU] =
{
    ...
    npc =
    {
        QM =
        {
            ...
            -- [16941678] = { trade = { { item = xi.items.NIGHTMARE_ROAST, mob = 16941520 } } }, -- Lost Barong
            -- [16941679] = { trade = { { item = xi.items.NIGHTMARE_LOIN, mob = 16941576 } } }, -- Lost Alklha
            -- [16941680] = { trade = { { item = xi.items.NIGHTMARE_CHOP, mob = 16941666 } } }, -- Lost Aitvaras
        },
    },
}

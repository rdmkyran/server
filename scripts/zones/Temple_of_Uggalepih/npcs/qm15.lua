...
entity.onEventFinish = function(player, csid, option)
    if
        csid == 67 and
        npcUtil.completeQuest(player, xi.quest.log_id.SANDORIA, xi.quest.id.sandoria.KNIGHT_STALKER, { item = xi.items.DRACHEN_ARMET, fame = 60, title = xi.title.PARAGON_OF_DRAGOON_EXCELLENCE, var = { "KnightStalker_Kill", "KnightStalker_Progress" } })
    then

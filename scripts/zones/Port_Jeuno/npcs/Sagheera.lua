...
local afArmorPlusOne =
{
    ...
    [ 10] = { trade = { xi.items.TEMPLE_GAITERS,                 xi.items.UTOPIAN_GOLD_THREAD,           xi.items.ANCIENT_BRASS_INGOT,            xi.items.SQUARE_OF_BLACK_TIGER_LEATHER  }, abc = 20, reward = xi.items.TEMPLE_GAITERS_P1          },
    ...
    [ 25] = { trade = { xi.items.WARLOCKS_BOOTS,                 xi.items.SPOOL_OF_RUBY_SILK_THREAD,     xi.items.SQUARE_OF_CARDINAL_CLOTH,       xi.items.SQUARE_OF_BLACK_TIGER_LEATHER  }, abc = 25, reward = xi.items.WARLOCKS_BOOTS_P1          },
    ...
    [ 31] = { trade = { xi.items.GALLANT_CORONET,                xi.items.CHUNK_OF_SNOWY_CERMET,         xi.items.WHITE_RIVET,                    xi.items.GOLD_INGOT                     }, abc = 25, reward = xi.items.GALLANT_CORONET_P1         },
    ...
    [ 33] = { trade = { xi.items.GALLANT_GAUNTLETS,              xi.items.CHUNK_OF_SNOWY_CERMET,         xi.items.WHITE_RIVET,                    xi.items.BLESSED_MYTHRIL_SHEET          }, abc = 20, reward = xi.items.GALLANT_GAUNTLETS_P1       },
    [ 34] = { trade = { xi.items.GALLANT_BREECHES,               xi.items.CHUNK_OF_SNOWY_CERMET,         xi.items.WHITE_RIVET,                    xi.items.BLESSED_MYTHRIL_SHEET          }, abc = 20, reward = xi.items.GALLANT_BREECHES_P1        },
    [ 35] = { trade = { xi.items.GALLANT_LEGGINGS,               xi.items.CHUNK_OF_SNOWY_CERMET,         xi.items.WHITE_RIVET,                    xi.items.BLESSED_MYTHRIL_SHEET          }, abc = 20, reward = xi.items.GALLANT_LEGGINGS_P1        },
    [ 36] = { trade = { xi.items.CHAOS_BURGEONET,                xi.items.DARK_ORICHALCUM_INGOT,         xi.items.BLACK_RIVET,                    xi.items.DARKSTEEL_SHEET                }, abc = 25, reward = xi.items.CHAOS_BURGEONET_P1         },
    ...
    [ 38] = { trade = { xi.items.CHAOS_GAUNTLETS,                xi.items.DARK_ORICHALCUM_INGOT,         xi.items.BLACK_RIVET,                    xi.items.DARKSTEEL_SHEET                }, abc = 15, reward = xi.items.CHAOS_GAUNTLETS_P1         },
    [ 39] = { trade = { xi.items.CHAOS_FLANCHARD,                xi.items.DARK_ORICHALCUM_INGOT,         xi.items.BLACK_RIVET,                    xi.items.DARKSTEEL_SHEET                }, abc = 20, reward = xi.items.CHAOS_FLANCHARD_P1         },
    [ 40] = { trade = { xi.items.CHAOS_SOLLERETS,                xi.items.DARK_ORICHALCUM_INGOT,         xi.items.BLACK_RIVET,                    xi.items.DARKSTEEL_SHEET                }, abc = 20, reward = xi.items.CHAOS_SOLLERETS_P1         },
    ...
    [ 44] = { trade = { xi.items.BEAST_TROUSERS,                 xi.items.SQUARE_OF_SMALT_LEATHER,       xi.items.FETID_LANOLIN_CUBE,             xi.items.SQUARE_OF_DHALMEL_LEATHER      }, abc = 30, reward = xi.items.BEAST_TROUSERS_P1          },
    [ 45] = { trade = { xi.items.BEAST_GAITERS,                  xi.items.SQUARE_OF_SMALT_LEATHER,       xi.items.FETID_LANOLIN_CUBE,             xi.items.SQUARE_OF_DHALMEL_LEATHER      }, abc = 20, reward = xi.items.BEAST_GAITERS_P1           },
    [ 46] = { trade = { xi.items.CHORAL_ROUNDLET,                xi.items.SPOOL_OF_COILED_YARN,          xi.items.SQUARE_OF_BROWN_DOESKIN,        xi.items.SPOOL_OF_GOLD_THREAD           }, abc = 15, reward = xi.items.CHORAL_ROUNDLET_P1         },
    ...
    [ 53] = { trade = { xi.items.HUNTERS_BRACERS,                xi.items.SPOOL_OF_CHAMELEON_YARN,       xi.items.SQUARE_OF_CHARCOAL_COTTON,      xi.items.SQUARE_OF_COEURL_LEATHER       }, abc = 20, reward = xi.items.HUNTERS_BRACERS_P1         },
    [ 54] = { trade = { xi.items.HUNTERS_BRACCAE,                xi.items.SPOOL_OF_CHAMELEON_YARN,       xi.items.SQUARE_OF_CHARCOAL_COTTON,      xi.items.SQUARE_OF_COEURL_LEATHER       }, abc = 25, reward = xi.items.HUNTERS_BRACCAE_P1         },
    [ 55] = { trade = { xi.items.HUNTERS_SOCKS,                  xi.items.SPOOL_OF_CHAMELEON_YARN,       xi.items.SQUARE_OF_CHARCOAL_COTTON,      xi.items.SQUARE_OF_BLACK_TIGER_LEATHER  }, abc = 25, reward = xi.items.HUNTERS_SOCKS_P1           },
    [ 56] = { trade = { xi.items.MYOCHIN_KABUTO,                 xi.items.SPOOL_OF_SCARLET_ODOSHI,       xi.items.SHEET_OF_KUROGANE,              xi.items.GOLD_SHEET                     }, abc = 15, reward = xi.items.MYOCHIN_KABUTO_P1          },
    ...
    [ 68] = { trade = { xi.items.DRACHEN_FINGER_GAUNTLETS,       xi.items.SHEET_OF_COBALT_MYTHRIL,       xi.items.BLUE_RIVET,                     xi.items.SQUARE_OF_RAM_LEATHER          }, abc = 20, reward = xi.items.DRACHEN_FINGER_GAUNTLETS_P1},
    [ 69] = { trade = { xi.items.DRACHEN_BRAIS,                  xi.items.SHEET_OF_COBALT_MYTHRIL,       xi.items.BLUE_RIVET,                     xi.items.SQUARE_OF_RAM_LEATHER          }, abc = 25, reward = xi.items.DRACHEN_BRAIS_P1           },
    [ 70] = { trade = { xi.items.DRACHEN_GREAVES,                xi.items.SHEET_OF_COBALT_MYTHRIL,       xi.items.BLUE_RIVET,                     xi.items.SQUARE_OF_RAM_LEATHER          }, abc = 20, reward = xi.items.DRACHEN_GREAVES_P1         },
    ...
    [ 75] = { trade = { xi.items.EVOKERS_PIGACHES,               xi.items.SPOOL_OF_GLITTERING_YARN,      xi.items.SQUARE_OF_ASTRAL_LEATHER,       xi.items.PIECE_OF_ANCIENT_LUMBER        }, abc = 15, reward = xi.items.EVOKERS_PIGACHES_P1        },
    ...
    [ 91] = { trade = { xi.items.DANCERS_TIARA_M,                xi.items.SQUARE_OF_FILET_LACE,          xi.items.GOLD_STUD,                      xi.items.GOLD_INGOT                     }, abc = 30, reward = xi.items.DANCERS_TIARA_M_P1         },
    ...
    [ 93] = { trade = { xi.items.DANCERS_BANGLES_M,              xi.items.SQUARE_OF_FILET_LACE,          xi.items.GOLD_STUD,                      xi.items.GOLD_INGOT                     }, abc = 25, reward = xi.items.DANCERS_BANGLES_M_P1       },
    ...
    [201] = { trade = { xi.items.DANCERS_TIARA_F,                xi.items.SQUARE_OF_FILET_LACE,          xi.items.GOLD_STUD,                      xi.items.GOLD_INGOT                     }, abc = 30, reward = xi.items.DANCERS_TIARA_F_P1         },
    ...
    [203] = { trade = { xi.items.DANCERS_BANGLES_F,              xi.items.SQUARE_OF_FILET_LACE,          xi.items.GOLD_STUD,                      xi.items.GOLD_INGOT                     }, abc = 25, reward = xi.items.DANCERS_BANGLES_F_P1       },
...
local relicArmorPlusOne =
{
    ...
    [133] = { trade = { xi.items.VALOR_GAUNTLETS,                xi.items.VALOR_GAUNTLETS_M1,            xi.items.BLESSED_MYTHRIL_SHEET,            { xi.items.ORDELLE_BRONZEPIECE,            30 } }, reward = xi.items.VALOR_GAUNTLETS_P1        },
    [134] = { trade = { xi.items.VALOR_BREECHES,                 xi.items.VALOR_BREECHES_M1,             xi.items.BLESSED_MYTHRIL_SHEET,            { xi.items.ORDELLE_BRONZEPIECE,            30 } }, reward = xi.items.VALOR_BREECHES_P1         },
    [135] = { trade = { xi.items.VALOR_LEGGINGS,                 xi.items.VALOR_LEGGINGS_M1,             xi.items.BLESSED_MYTHRIL_SHEET,            { xi.items.ORDELLE_BRONZEPIECE,            30 } }, reward = xi.items.VALOR_LEGGINGS_P1         },
    ...
    [153] = { trade = { xi.items.SCOUTS_BRACERS,                 xi.items.SCOUTS_BRACERS_M1,             xi.items.SQUARE_OF_COEURL_LEATHER,         { xi.items.TUKUKU_WHITESHELL,              30 } }, reward = xi.items.SCOUTS_BRACERS_P1         },
    [154] = { trade = { xi.items.SCOUTS_BRACCAE,                 xi.items.SCOUTS_BRACCAE_M1,             xi.items.SQUARE_OF_COEURL_LEATHER,         { xi.items.TUKUKU_WHITESHELL,              30 } }, reward = xi.items.SCOUTS_BRACCAE_P1         },
    ...
    [156] = { trade = { xi.items.SAOTOME_KABUTO,                 xi.items.SAOTOME_KABUTO_M1,             xi.items.GOLD_SHEET,                       { xi.items.ONE_BYNE_BILL,                  24 } }, reward = xi.items.SAOTOME_KABUTO_P1         },
    ...
    [175] = { trade = { xi.items.SUMMONERS_PIGACHES,             xi.items.SUMMONERS_PIGACHES_M1,         xi.items.PIECE_OF_ANCIENT_LUMBER,          { xi.items.TUKUKU_WHITESHELL,              28 } }, reward = xi.items.SUMMONERS_PIGACHES_P1     },
...
local function getCosmoCleanseTime(player)
    local cosmoWaitTime = player:hasKeyItem(xi.ki.RHAPSODY_IN_MAUVE) and 3600 or xi.items.PIECE_OF_ANCIENT_LUMBER00

    ...
    [1] =
        {
            ...
            {
                { itemid = xi.items.DARK_ORICHALCUM_INGOT,     droprate =  65 },
                { itemid = xi.items.SQUARE_OF_DIABOLIC_SILK,   droprate =  97 },
                { itemid = xi.items.SQUARE_OF_SMALT_LEATHER,   droprate =  40 },
                { itemid = xi.items.CHUNK_OF_SNOWY_CERMET,     droprate =  95 },
                { itemid = xi.items.PANTIN_WIRE,               droprate = 194 },
                { itemid = xi.items.SQUARE_OF_FILET_LACE,      droprate =  32 },
                { itemid = xi.items.SPOOL_OF_CHAMELEON_YARN,   droprate = 161 },
            },
        },
        ...
        [2] =
        {
...

            {
                ...
                { itemid = xi.items.CHUNK_OF_SNOWY_CERMET,     droprate = 333 },
                { itemid = xi.items.SPOOL_OF_GLITTERING_YARN,  droprate =  20 },
                { itemid = xi.items.SHEET_OF_COBALT_MYTHRIL,   droprate = 106 },
                { itemid = xi.items.SPOOL_OF_RUBY_SILK_THREAD, droprate =  33 },
                { itemid = xi.items.DARK_ORICHALCUM_INGOT,     droprate =  76 },
                { itemid = xi.items.SPOOL_OF_COILED_YARN,      droprate =  95 },
                { itemid = xi.items.SPOOL_OF_SILKWORM_THREAD,  droprate =  67 },
                { itemid = xi.items.SQUARE_OF_SMALT_LEATHER,   droprate = 133 },
            },
        ...
        [3] =
        {
...

            {
                ...
                { itemid = xi.items.SPOOL_OF_SCARLET_ODOSHI,   droprate =  83 },
                { itemid = xi.items.SQUARE_OF_SMALT_LEATHER,   droprate =  50 },
                { itemid = xi.items.SQUARE_OF_SUPPLE_SKIN,     droprate =  83 },
                { itemid = xi.items.SQUARE_OF_DIABOLIC_SILK,   droprate =  70 },
                { itemid = xi.items.SPOOL_OF_RUBY_SILK_THREAD, droprate =  42 },
                { itemid = xi.items.SPOOL_OF_COILED_YARN,      droprate =  42 },
                { itemid = xi.items.PANTIN_WIRE,               droprate = 292 },
            },
        ...
        [4] =
        {
...

            {
                ...
                { itemid = xi.items.SQUARE_OF_SUPPLE_SKIN,     droprate = 167 },
                { itemid = xi.items.SQUARE_OF_SMALT_LEATHER,   droprate =  62 },
                { itemid = xi.items.SQUARE_OF_DIABOLIC_SILK,   droprate =  69 },
                { itemid = xi.items.PANTIN_WIRE,               droprate = 208 },
                { itemid = xi.items.SPOOL_OF_SCARLET_ODOSHI,   droprate =  42 },
                { itemid = xi.items.SPOOL_OF_SILKWORM_THREAD,  droprate =  83 },
            },
        ...
        [5] =
        {
...

            {
                ...
                { itemid = xi.items.SQUARE_OF_SUPPLE_SKIN,     droprate =  83 },
                { itemid = xi.items.CHUNK_OF_SNOWY_CERMET,     droprate =  20 },
                { itemid = xi.items.SPOOL_OF_SCARLET_ODOSHI,   droprate =  94 },
                { itemid = xi.items.SHEET_OF_COBALT_MYTHRIL,   droprate =  42 },
                { itemid = xi.items.SQUARE_OF_DIABOLIC_SILK,   droprate =  49 },
                { itemid = xi.items.SPOOL_OF_CHAMELEON_YARN,   droprate = 167 },
                { itemid = xi.items.SQUARE_OF_FILET_LACE,      droprate = 458 },
            },
        ...
        [6] =
        {
...

            {
                ...
                { itemid = xi.items.SQUARE_OF_SUPPLE_SKIN,     droprate =  74 },
                { itemid = xi.items.SHEET_OF_COBALT_MYTHRIL,   droprate =  74 },
                { itemid = xi.items.SPOOL_OF_CHAMELEON_YARN,   droprate =  62 },
                { itemid = xi.items.SPOOL_OF_LUMINIAN_THREAD,  droprate = 150 },
                { itemid = xi.items.SPOOL_OF_RUBY_SILK_THREAD, droprate =  76 },
                { itemid = xi.items.SPOOL_OF_SCARLET_ODOSHI,   droprate =  53 },
                { itemid = xi.items.SPOOL_OF_SILKWORM_THREAD,  droprate = 111 },
                { itemid = xi.items.SQUARE_OF_FILET_LACE,      droprate = 370 },
                { itemid = xi.items.SQUARE_OF_SMALT_LEATHER,   droprate = 333 },
            },
        ...
        [7] =
        {
            ...
            {
                { itemid = xi.items.CHUNK_OF_SNOWY_CERMET,     droprate =  38 },
                { itemid = xi.items.SPOOL_OF_CHAMELEON_YARN,   droprate =  67 },
                { itemid = xi.items.DARK_ORICHALCUM_INGOT,     droprate = 100 },
                { itemid = xi.items.SQUARE_OF_DIABOLIC_SILK,   droprate = 233 },
                { itemid = xi.items.SQUARE_OF_SMALT_LEATHER,   droprate =  80 },
                { itemid = xi.items.PANTIN_WIRE,               droprate = 333 },
                { itemid = xi.items.SQUARE_OF_FILET_LACE,      droprate =  67 },
            },

            {
                { itemid = xi.items.SCARLET_CHIP,              droprate = 1000 },
            },
